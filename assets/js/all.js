...
$(document).ready(function () {
  $(window).scroll(function () {
    ...
    var jumbotron = $('.jumbotron').offset().top;

    if (scrolled + windowHeight >= gearBg) {
      $('.gear-bg').css("background-position", "-".concat(parseInt($(this).scrollTop() * 0.1), "px center"));
    }

    if (scrolled + windowHeight >= strippedBg) {
      $('.stripped-bg').css("background-position", "-".concat(parseInt($(this).scrollTop() * 0.1), "px center"));
